...
pdf.cell(0, 10, "K-Means Clustering Report", align="C")

# Add Images (2 side by side, 1 below)
image1 = os.path.join(script_dir, "kmeans_clusters.png")
image2 = os.path.join(script_dir, "kmeans_pca.png")
image3 = os.path.join(script_dir, "kmeans_confusion_matrix.png")

pdf.image(image1, x=10, y=55, w=90)
pdf.image(image2, x=110, y=55, w=90)
pdf.image(image3, x=60, y=130, w=90)

pdf.ln(190)  # Ensure table starts after images

# # Section Title
# pdf.set_font("Times", "B", 12)
# pdf.cell(0, 10, "K-Means Output", new_x="LMARGIN", new_y="NEXT", align="C")
# pdf.ln(5)

# # Load and Display kmeans_output.csv with Fixed Column Widths
# kmeans_output_path = os.path.join(script_dir, "kmeans_output.csv")
# df = pd.read_csv(kmeans_output_path)
...
# Save PDF
pdf.output(os.path.join(script_dir, "kmeans_report.pdf"))
